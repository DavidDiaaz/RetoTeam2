...
///
/// MinFollowingDistance : absolute minimum gap (units) — never go below this
...
///
/// Scale: 1 Unity unit = 3.5 m real-world (lane width anchor).
/// All distance values are in Unity units.
/// </summary>
public class Profile
{
    ...
    {
        // Tailgater  →  MinGap 0.29u (1m),  TimeGap 0.8 s,  Speed 105%
        // Average    →  MinGap 0.57u (2m),  TimeGap 1.5 s,  Speed 100%
        // Cautious   →  MinGap 1.14u (4m),  TimeGap 2.5 s,  Speed  90%
        float t = (float)rng.NextDouble(); // 0 = aggressive, 1 = cautious

        return new Profile
        {
            MinFollowingDistance = Lerp(0.29f, 1.14f, t),
